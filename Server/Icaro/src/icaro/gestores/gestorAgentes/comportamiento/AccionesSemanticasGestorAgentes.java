...
//                InterfazUsoAgente itfUsosAg = (InterfazUsoAgente) descGN.getIntfUsoAgente();
                ...
                try {
                    descGN.getIntfUsoAgente().aceptaMensaje(new MensajeSimple(new InfoContEvtMsgAgteReactivo("peticion_terminar_todo", null), this.nombreAgente, NombresPredefinidos.NOMBRE_GESTOR_NODO));
