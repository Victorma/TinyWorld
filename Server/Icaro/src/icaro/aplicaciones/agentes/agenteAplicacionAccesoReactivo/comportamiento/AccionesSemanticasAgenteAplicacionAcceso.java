...
public class AccionesSemanticasAgenteAplicacionAcceso extends AccionesSemanticasAgenteReactivo {
    ...
    /**
     * Acción de inicialización de las actividades del agente. Se obtiene la interfaz del recurso de
     * visualizacion y del recurso de persistencia para utilizarlos cuando haga falta se le ordena
     * que muestre la ventana de acceso
     */
     ...
     * resultado de la validación para que se ejecute la transición correspondiente al estado en que
     * se encuentra el agente. " infoUsuario.tomaUsuario(),infoUsuario.tomaPassword()" son los
     * parametros que se le pasan a la accion asociada a la transición
     *
     * @param infoUsuario contien la información introducida por el usuario y enviada por el recurso
     * de visualizacion
     */
...
//			Object[] datosEnvio = new Object[]{infoUsuario.tomaUsuario(), infoUsuario.tomaPassword()};
     ...
     * través del recurso de visualización. Se utiliza la clase comunicator que será la encargada de
     * buscar la interfaz del agente receptor, crear un mensaje con la información a enviar y
     * enviarla al agente.
     */
