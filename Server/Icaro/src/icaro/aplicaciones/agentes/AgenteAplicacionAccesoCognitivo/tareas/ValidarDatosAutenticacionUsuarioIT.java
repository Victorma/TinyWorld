...
// Se obtienen las interfaces de los recursos. Si no se pueden obtener las interfaces se debe generar un informe de tarea
            ...
            if (visualizadorAcceso == null) {
                this.generarInformeConCausaTerminacion(identTarea, contextoEjecucionTarea, identAgenteOrdenante, "Error-Al Obtener la interfaz de u so de :" + IdentRecursoVisualizacionAcceso, CausaTerminacionTarea.ERROR);
            } else {
            ...
            if (itfUsoPersistencia == null) {
                ...
                boolean resultadoValidacion = itfUsoPersistencia.compruebaUsuario(infoAcceso.tomaUsuario(), infoAcceso.tomaPassword());
