...
//	}
    ...
    public InterfazUsoAgente getItfUsoAgenteAReportar(String identAgteAreportar) {
        ...
        try {
            itfUsoAgteAreportar = (InterfazUsoAgente) NombresPredefinidos.REPOSITORIO_INTERFACES_OBJ.obtenerInterfaz(NombresPredefinidos.ITF_USO + identAgteAreportar);
        } catch (Exception e) {
    ...
    /**
     * @return @uml.property name="tipoAgenteAcceso"
     */
