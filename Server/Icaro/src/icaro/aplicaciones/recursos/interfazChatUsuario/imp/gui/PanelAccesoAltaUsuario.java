...
// <editor-fold defaultstate="collapsed" desc=" C�digo Generado  ">
    ...
    private void botonAltaActionPerformed(java.awt.event.ActionEvent evt) throws Exception {
        ...
        if ((pwd.equals("")) || (confirm.equals(""))) //            usoAgente.getVisualizador().mostrarMensajeError("Error", "Los valores no pueden ser vacios");
        {
        ...
        } else //            usoAgente.getVisualizador().mostrarMensajeAviso("Cuidado","los valores de la clave no coinciden. Deben ser iguales" );
        {
