...
public class NombresPredefinidos {
    ...
    public static <T> T getUseInterface(String name) throws Exception {
        return (T) REPOSITORIO_INTERFACES_OBJ.obtenerInterfazUso(name);
    }

    public static <T> T getInterface(String name) throws Exception {
        return (T) REPOSITORIO_INTERFACES_OBJ.obtenerInterfaz(name);
    }
    
    public static void removeInterfaceRegister(String name) throws Exception {
        REPOSITORIO_INTERFACES_OBJ.eliminarRegistroInterfaz(name);
    }
}
