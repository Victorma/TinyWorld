...
public class Buzon implements Itf_ProductorBuzonTimeout, Itf_ConsumidorBuzonTimeout {
     ...
     * @exception ExcepcionTimeOutSuperado Excepcion producida tras el tiempo especificado
     */
    ...
    /**
     * Introduce un nuevo evento en el buzn, se ignoran nuevos eventos si el buzn no est activo
     *
