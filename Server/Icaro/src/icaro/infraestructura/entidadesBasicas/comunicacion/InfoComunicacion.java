...
public class InfoComunicacion {
    ...
    public Object obtenerInterfaz(String IdentAgenteReceptor) {
        ...
        try {
            ...
            itfUsoAgenteReceptor = (ItfUsoAgenteReactivo) itfUsoRepositorio.obtenerInterfaz(NombresPredefinidos.ITF_USO + IdentAgenteReceptor);
...
//        }
    ...
    public void mandarEventoAAgenteId(String input, Object infoComplementaria, String IdentAgenteReceptor) {
        ...
        if (infoComplementaria == null) {
            ...
            eventoaEnviar = new EventoRecAgte(input, infoComplementaria, identAgenteEmisor, IdentAgenteReceptor);
        }
