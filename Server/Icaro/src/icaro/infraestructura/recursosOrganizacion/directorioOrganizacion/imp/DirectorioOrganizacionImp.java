...
public class DirectorioOrganizacionImp extends ClaseGeneradoraDirectorioOrganizacion {
    ...
    public synchronized void eliminarRegistroInterfaz(String nombre) {
        ...
        if (this.repositorio.containsKey(nombre)) {
            ...
            if (DEBUG) {
                System.out.println("Se elimin la referencia a " + nombre + " del repositorio de interfaces.");
            }
        } else if (DEBUG) {
            System.out.println("Se intent eliminar la referencia " + nombre + " del repositorio, pero no estaba definida.");
        }
    }
    ...
    public String getValorPropiedadGlobal(String atributo)
         ...
         * Pruebas
         *
         * public static void main(String[] args) { Object obj1 = new Object(); Object obj2 = new
