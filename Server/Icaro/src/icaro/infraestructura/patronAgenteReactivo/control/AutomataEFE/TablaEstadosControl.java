...
public class TablaEstadosControl {
     ...
     * @uml.associationEnd qualifier="input:java.lang.String
     * icaro.infraestructura.entidadesBasicas.componentesBasicos.automata.imp.Operacion"
     */
    ...
    /**
     * Determina si el input dado es uno de los inputs que se esperan en el estado dado
     *
     * @param estado Estado a evaluar
