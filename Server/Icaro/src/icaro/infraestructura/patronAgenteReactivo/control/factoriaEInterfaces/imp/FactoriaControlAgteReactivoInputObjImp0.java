...
//	public static FactoriaControlAgteReactivoInputObjImp0 instance() throws ExcepcionEnComponente, RemoteException {
//            try {
//            if (instance == null)
...
//                return new ProcesadorInfoReactivoAutInObjImp0(interpAutomat, agente);
 ...
 private void generarErrorCreacionAutomata (String nombreFicheroTablaEstados){
             logger.error("Error al crear el automata del agente " + nombreAgente + " utilizando el fichero " + nombreFicheroTablaEstados);
                if(this.recursoTrazas == null)this.crearRecursoTrazas();
